...
const BaseStationList: React.FC = () => {
  ...
  const [currentRecord, setCurrentRecord] = useState<BaseStationDO | null>(null);
  
  // 定义列配置在组件内部
  const columns: Array<ProColumns<BaseStationDO>> = [
    {
      title: 'ID',
      dataIndex: 'id',
      width: 80,
  ...
  const handleEdit = (record: BaseStationDO) => {
